		...
		<div class="navbar_emp container-fluid">
			<nav class="navigation_bar_emp">
				...
				<div class="nav_menu_emp">
					...
					<a
						href="updateProfile.jsp" class="btn btn-primary">Update Profile</a>
						<a
	...
	<div class="container updated_profile">
		<div class="row">
			<div class="col-md-5 offset-md-3">
				<h3> Name : <%= user.getFname().toUpperCase() + " "+user.getLname().toUpperCase()  %> </h3>
				 <br> <h3> DateOfBirth : <%= user.getDateOfBirth() %> </h3>
