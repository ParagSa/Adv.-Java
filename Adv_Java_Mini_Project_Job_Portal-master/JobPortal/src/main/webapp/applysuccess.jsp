			...
			<div class="navigation_bar_emp">
				...
				<div class="nav_menu_emp">
					<a href="emphome.jsp" class="btn btn-success">Home</a> <a
						href="searchjob.jsp" class="btn btn-secondary">Search another
						Job</a> <a href="appliedjobs" class="btn btn-info">Applied Jobs</a> <a
						href="logoutUser" class="btn btn-danger">LogOut</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container postsuccess ">
			<div class="row">
				<div class="col-md-4 offset-md-4">
					...
					<p class="lead">Your will be notified by recruiter shortly!</p>
				</div>
			</div>
		</div>
	</section>
