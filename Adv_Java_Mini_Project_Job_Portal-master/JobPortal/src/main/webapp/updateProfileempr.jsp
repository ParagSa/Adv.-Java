...
%>
		...
		<div class="navbar_emp container-fluid">
			<nav class="navigation_bar_emp">
				...
				<div class="nav_menu_emp">
					...
					<a
						href="UserEmprDetails.jsp" class="btn btn-primary">View Profile</a> <a
						href="postjobempr.jsp" class="btn btn-success">Post a job</a> <a
	...
	<div class="container update_profile">
		<div class="row">
