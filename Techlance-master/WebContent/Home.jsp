					...
					<form method="GET" action="HomeController">
						<tr>
							<td><input type="submit"
								...
								name="home_btn" class="button" value="My Workspace"></td>
							<td><input type="submit"
								class="w3-button w3-xxlarge w3-black w3-padding2"
								name="home_btn" class="button" value="Profile"></td>
							<td><input type="submit"
								class="w3-button w3-xxlarge w3-black w3-padding2"
								name="home_btn" class="button" value="Message"></td>
							<td><input type="submit"
								class="w3-button w3-xxlarge w3-black w3-padding2"
								name="home_btn" class="button" value="Notification"></td>
							...
							<td><input type="submit"
								class="w3-button w3-xxlarge w3-black w3-padding2"
								name="home_btn" class="button" value="Suggested Projects">
							</td>
							<td><input type="submit"
								class="w3-button w3-xxlarge w3-black w3-padding2"
